...
function HG() {
  ...
  function excludeUser(msg, id, game) {
    ...
    if (specialWords.everyone.includes(firstWord)) {
      ...
      self.excludeUsers(mentions, id, (res) => self.common.reply(msg, res));
    }
  }
  ...
  function includeUser(msg, id, game) {
    ...
    if (specialWords.everyone.includes(firstWord)) {
      ...
      self.includeUsers(
          mentions, id, (response) => self.common.reply(msg, response));
    }
  }
    ...
    if (teamId1 < 0 || teamId2 < 0 || isNaN(teamId2)) {
      ...
      if (user2 > 0 && teamId2 < 0) {
        extra = strings.get(
            ...
            self.client.users.get(user2).username);
      } else if (user1 > 0 && teamId1 < 0) {
        extra = strings.get(
            'teamMoveNoTeam', msg.locale,
            self.client.users.get(user1).username);
      }
